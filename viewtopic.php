...
require PUN_ROOT.'footer.php';
    ...
    if ($pun_config['o_avatars'] == '1' && $pun_user['show_avatars'] != '0')
      $user_avatar = '<img src="http://www.gravatar.com/avatar/205e460b479e2e5b48aec07710c08d50?d=mm&amp;s=130&amp;f=y" height="'.$pun_config['o_avatars_height'].'" width="'.$pun_config['o_avatars_width'].'" alt="" />';