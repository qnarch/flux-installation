...
<div class="blockform">
	...
	<div class="box">
    <legend><?php echo $lang_profile['Avatars disabled'] ?></legend>
	</div>
</div>
<?php
	...
	$user['g_moderator'] == '1'))))																// or the user is another mod
{
	...
	if ($pun_config['o_avatars'] == '1')
	{
		$avatar_field = generate_gravatar_markup($user['email']);
		if ($avatar_field != '')
		{
...
<?php
    ...
    $user_avatar = generate_gravatar_markup($user['email']);
    
    if ($has_gravatar)
      $avatar_field = '<span><a href="https://www.gravatar.com/emails/" target="_blank">'.$lang_profile['Change avatar'].'</a></span>';
    else
      $avatar_field = '<span><a href="https://www.gravatar.com/site/signup/'.urlencode($user['email']).'" target="_blank">'.$lang_profile['Upload avatar'].'</a></span>';
