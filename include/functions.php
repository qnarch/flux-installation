...
//
function generate_gravatar_markup($user_email)
{
	global $pun_config;

	$gravatar_markup = '';
  $default = "mm";    // mm|identicon|monsterid|wavatar|retro|blank|urlencode('http://me.com/default.jpg')
  $grav_url = "http://www.gravatar.com/avatar/".md5(strtolower(trim($user_email)))."?d=".$default."&amp;s=".$pun_config['o_avatars_width'];
  $img_size = 'height="'.$pun_config['o_avatars_height'].'" width="'.$pun_config['o_avatars_width'].'"';
  $gravatar_markup = '<img src="'.$grav_url.'" '.$img_size.' alt="" />';

	return $gravatar_markup;
}
